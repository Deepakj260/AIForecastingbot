...
st.markdown("Upload your Excel file with at least 2 years of firm schedule history.")
uploaded_file = st.file_uploader("Upload firm schedule file", type="xlsx")
...
if uploaded_file:
    ...
    # Feature set creation for training
    ...
    # Upload new firm schedule for future prediction
    st.markdown("---")
    st.markdown("📥 Upload future firm schedule to predict actual lifting")
    future_file = st.file_uploader("Upload future firm schedule (same format)", type="xlsx")
