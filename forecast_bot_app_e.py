...
if uploaded_file:
    ...
    # Calculate CAGR based on actual lifting
    ...
    # Forecast for next 24 months aligned with actual CAGR only
    st.subheader("📈 Forecast Firm Schedule and Lifting (Correlated with Actual CAGR)")
    ...
    ax.set_title("24-Month Forecasted Firm Schedule Aligned to Actual CAGR")
    ax.set_xlabel("Month")
